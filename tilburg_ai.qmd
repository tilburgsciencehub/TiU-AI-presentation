...
subtitle: "Educate, Encourage, Experiment, Scale-up, Innovate"
format:
  revealjs: 
    logo: img/logo.png
    slide-number: true
...
- ChatGPT is "just" an interface to OpenAI's APIs (and its latest version, ["GPT-4 API"](https://openai.c
  om/product/gpt-4), was just announced yesterday)
    ...
    - Educational use: student feedback (Khan Academy), conversations in foreign languages (Duolingo)

::: goal
In __thinking about using AI in Tilburg__, we can apply AI __manually__ ("hey, here's an exam question - can you create 5 different versions?"), and scale up successful use cases __automatically__.
:::
